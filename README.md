...
5. **懐中電灯を遮る**：左岸から2.0高い棚へ登り、棚の内側にある2つの緑Hookを長さ6の足場で結ぶ。棚間4.4に対してたわみ1.6が生まれ、光源の真下を通って遮光する。光が0.4秒で暗くなったら、谷側の青Hook`(97.0, 2.95)`へ長さ7で掛けて右岸へ渡る。右棚端から右岸までは約11.6空け、通常ジャンプの近道を防ぐ。茶色い取付ブロックは青Hookの真上に揃え、遮光判定用の見えない起点だけを橋中央に残す
