...
5. **懐中電灯を遮る**：左岸から1.5高い棚へ登り、棚の内側にある2つの緑Hookを長さ6の足場で結ぶ。棚間4.4に対してたわみ1.6が生まれ、光源の真下を通って遮光する。光が0.4秒で暗くなったら、谷側の青Hook`(97.0, 2.45)`へ長さ7で掛けて右岸へ渡る。右棚端から右岸までは約7.6空け、通常ジャンプの近道を防ぐ。遮光用の光源は橋中央に残し、青Hookとは別の固定物として扱う
