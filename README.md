...
8. **垂れた底を道にする**：第7区間の右岸端と、5離れた対岸の緑Hookをヒモ足場で結ぶ。左右の壁から1ずつ張り出した床により、縦穴の口は幅3になる。現在の足場式では中央の底が`端の高さ - (選択長 - 5)`になるため、長さ7は深さ2、長さ8は深さ3で穴の口へ安全に降りられる。長さ5〜6は穴の口より浅く、長さ9以上は足場自体が底のトゲへ触れて区間の最初へ戻る。安全な足場の底から横約1.6の低い通路へジャンプして抜ける
