...
7. **先に、作る**：第6区間の合流床から中段へ長さ4の足場を先に作り、中段、上段の順にジャンプしてから、上段の青Hookへ長さ5で掛けて対岸へ渡る。合流床から青Hookへ直接掛けると長さ14の最下点が落下判定より下へ入る。第6区間で上ルートを選んだ場合は最初の足場が無償で引き継がれ、下ルートなら残量39から4を消費して作る
