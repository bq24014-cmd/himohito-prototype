...
ヒモ橋を歩くと、足音のタイミングで足元付近の毛糸だけが最大0.04ほど沈み、約0.34秒で戻ります。橋の端・コライダー・プレイヤーを支える曲線は固定で、Q生成／F統合演出中は歩行の揺れを出しません。音の追加はありません。
...
本編のゴール床も幅15（X=203〜218）、宝箱X=214とし、両ステージとも床の左端から宝箱中心まで11、右端まで4の配置に統一しています。床の高さ・橋の両端は従来どおりです。
