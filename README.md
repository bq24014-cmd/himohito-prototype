...
2. **長さを選ぶ**：T1の着地床を左岸として対岸と中央Hookを置く。対岸の中心はX=`27`で、旧位置から右へ3移動している。初期長さ8ではプレイヤーの足元が木製トゲへ約0.72入り、長さ7では約0.28上を通り、長さ6でも振り幅を作れば対岸へ届く。T1から接続を保って入った場合は`E`で外し、`W/S`で6または7へ選び直して渡る。失敗してもヒモは消費しない
