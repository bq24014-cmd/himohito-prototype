...
- 空中そのものには接続できない
- 生成したヒモ足場は通常時に歩ける。歩行中は足元の局所的な傾斜に沿って地上速度を補正し、たわみの底を越えた時の慣性で橋から浮かないようにする。足場作成用Hookへの接続中は、`E`から`Q`まですべての生成済み足場との衝突を維持する。振り子用Hookへヒモ足場の上から接続した場合は、足場を離れるまで衝突を維持し、離れた後は無効にして振り子軌道を妨げない
